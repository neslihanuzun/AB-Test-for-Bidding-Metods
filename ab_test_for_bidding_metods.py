...
control_group_df = pd.read_excel(("ab_testing.xlsx"), sheet_name="Control Group", keep_default_na=True)
test_group_df = pd.read_excel(("ab_testing.xlsx"), sheet_name="Test Group", keep_default_na=True)
...
control_group_df.columns = ["c_"+i for i in control_group_df.columns]
test_group_df.columns = ["t_"+i for i in test_group_df.columns]
